...
const createUserData = async (req: Request, res: Response) => {
  try {
    ...
    const result = await userServicesData.createUserFromBD(validatedData);
    res.status(200).json({
      success: true,
...
const getAllUserData = async (req: Request, res: Response) => {
  try {
    const result = await userServicesData.getAllUserFromDB();
    res.status(200).json({
      success: true,
...
const getSingleUserData = async (req: Request, res: Response) => {
  try {
    ...
    const result = await userServicesData.getSingleUserFromDB(userId);
    res.status(200).json({
      success: true,
...
const updateUserData = async (req: Request, res: Response) => {
  try {
    const { userId } = req.params;
    const userData = req.body;
    const result = await userServicesData.updateUserFromDB(userId, userData);
    res.status(200).json({
      success: true,
...
const deleteUserData = async (req: Request, res: Response) => {
  try {
    const { userId } = req.params;
    await userServicesData.DeleteUserFromDB(userId);
    res.status(200).json({
      success: true,
...
const insertOrderCollection = async (req: Request, res: Response) => {
  try {
    ...
    const result = await userServicesData.insertOrderToUserFromDB(
      userId,
      order
    );
    res.status(200).json({
...
const getUserOrderData = async (req: Request, res: Response) => {
  try {
    const { userId } = req.params;
    const result = await userServicesData.getAllOrderToUserFromDB(userId);
    res.status(200).json({
      success: true,
...
const CalculateAllUserOrder = async (req: Request, res: Response) => {
  try {
    const { userId } = req.params;
    const totalPrice = await userServicesData.calculateAllOrderFromDB(userId);
    res.status(200).json({
      success: true,
